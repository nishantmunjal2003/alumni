            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-[#FDFDFC] rounded-lg border border-[#e3e3e0] overflow-hidden hover:shadow-lg transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="text-sm text-indigo-600 font-medium mb-4">
                        ...
                        @if($event->google_maps_link)
                            <div class="w-full rounded-lg overflow-hidden border border-gray-200 bg-gray-50">
                                <a href="{{ $event->google_maps_link }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 p-4 hover:bg-gray-100 transition-colors">
                                    ...
                                    <span class="text-indigo-600 font-medium">View on Google Maps</span>
                                    <svg class="w-4 h-4 text-indigo-600 ml-auto flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
