...
<div class="max-w-4xl mx-auto space-y-4 sm:space-y-6 px-4 sm:px-0">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
        ...
        <a href="{{ route('manager.campaigns.index') }}" class="text-sm text-indigo-600 hover:text-indigo-800 inline-flex items-center gap-1">
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6">
        ...
        <form method="GET" action="{{ route('manager.campaigns.email', $campaign->id) }}" id="filter-form" class="space-y-4">
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6">
        ...
        @if($recipientCount > 0)
            ...
            <form method="POST" action="{{ route('manager.campaigns.email.send', $campaign->id) }}" class="space-y-6">
                @csrf
