...
<div class="max-w-4xl mx-auto">
    ...
    <form method="POST" action="{{ route('manager.events.update', $event->id) }}" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-6">
        @csrf
        @method('PUT')
        <div class="space-y-6">
            <div>
        ...
        <div class="mt-6 flex gap-4">
            ...
            <a href="{{ route('manager.events.index') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-400 transition-colors">Cancel</a>
        </div>
    </form>
</div>
@endsection
