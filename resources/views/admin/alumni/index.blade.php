...
<div class="space-y-4 sm:space-y-6 px-4 sm:px-0">
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0">
        ...
        <a href="{{ route('admin.dashboard') }}" class="text-sm sm:text-base text-indigo-600 hover:text-indigo-800 inline-flex items-center gap-1">
    ...
    <div class="bg-white shadow rounded-lg p-4 sm:p-6">
        <form id="search-form" class="space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('admin.alumni.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-300 transition-colors text-center touch-manipulation">
                    Clear Filters
                </a>
        ...
        <div id="alumni-list" class="mt-6">
            @include('admin.alumni.partials.alumni-list', ['alumni' => $alumni])
        </div>
    </div>
</div>
...
(function() {
    ...
    function performSearch() {
        ...
        const url = '{{ route("admin.alumni.index") }}' + (params.toString() ? '?' + params.toString() : '');
    ...
    document.getElementById('export-excel-btn')?.addEventListener('click', function() {
        ...
        const url = '{{ route("admin.alumni.export") }}' + (params.toString() ? '?' + params.toString() : '');
    ...
    document.getElementById('send-email-all-btn')?.addEventListener('click', function() {
        ...
        const url = '{{ route("admin.alumni.email.bulk") }}' + (params.toString() ? '?' + params.toString() : '');
        window.location.href = url;
    });
})();
</script>
