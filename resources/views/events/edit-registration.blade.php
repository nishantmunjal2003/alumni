                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                <input type="radio" name="needs_stay" id="needs_stay_yes" value="1" {{ old('needs_stay', $registration->needs_stay ? '1' : '0') == '1' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                <label for="needs_stay_yes" class="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    I need accommodation
                                </label>
                            </div>
                            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                <input type="radio" name="needs_stay" id="needs_stay_no" value="0" {{ old('needs_stay', $registration->needs_stay ? '1' : '0') == '0' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
